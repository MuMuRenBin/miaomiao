...
<style>
    .messagebox{position:absolute;left:50%;top:50%;margin: -70px 0 0 -100px;width: 200px;height: 140px;border: 1px solid #ccc;border-radius: 3px;background-color: #fff;box-shadow: 3px #ccc;}
